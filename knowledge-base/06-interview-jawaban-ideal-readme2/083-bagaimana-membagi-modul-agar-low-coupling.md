# Bagaimana membagi modul agar low coupling?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana membagi modul agar low coupling?
...
> Low coupling saya capai dengan memecah modul berdasarkan perubahan yang cenderung bersama, bukan sekadar folder teknis. Strategi saya change-axis modularization: batas modul mengikuti arah perubahan domain agar ripple effect kecil. Dependency antar modul saya jaga lewat interface yang sempit dan stabil.

Struktur cepat:
- Konteks singkat: pada kasus "Bagaimana membagi modul agar low coupling?", saya mulai dari risiko tertinggi yang memengaruhi user dan operasi.
...
> Saya bangun low coupling dengan change-axis modularization agar perubahan di satu area tidak merambat liar.
...
- Definisi strategi: change-axis modularization = memisahkan modul berdasarkan pola perubahan domain untuk menekan dampak samping.
...
- Pertanyaan: Bagaimana membagi modul agar low coupling?
