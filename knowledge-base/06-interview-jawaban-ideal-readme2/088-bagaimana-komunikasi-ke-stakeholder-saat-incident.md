# Bagaimana komunikasi ke stakeholder saat incident?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana komunikasi ke stakeholder saat incident?
...
> Komunikasi ke stakeholder saat incident harus jujur, teratur, dan fokus pada dampak serta langkah mitigasi. Strategi saya cadence-based incident communication: update berkala dengan format tetap (impact, action, ETA, next update). Ini menurunkan kepanikan dan menjaga kepercayaan lintas fungsi selama penanganan.

Struktur cepat:
- Konteks singkat: pada kasus "Bagaimana komunikasi ke stakeholder saat incident?", saya mulai dari risiko tertinggi yang memengaruhi user dan operasi.
...
> Saat incident saya pakai update cadence tetap berisi dampak, tindakan, ETA, dan langkah berikutnya.
...
- Definisi strategi: cadence-based incident communication = pola komunikasi insiden terjadwal agar informasi tetap jelas dan konsisten.
...
- Pertanyaan: Bagaimana komunikasi ke stakeholder saat incident?
