# Bedanya logging, metrics, dan tracing?

## 1) Pertanyaan

- Pertanyaan interviewer: Bedanya logging, metrics, dan tracing?
...
> Logging menjawab kejadian detail, metrics menjawab tren kuantitatif, tracing menjawab alur lintas service. Strategi saya signal-layered diagnosis: gunakan sinyal yang tepat untuk jenis pertanyaan yang tepat. Biasanya saya mulai dari metrik untuk deteksi, lalu trace untuk lokalisasi, dan log untuk bukti akar masalah.

Struktur cepat:
- Konteks singkat: pada kasus "Bedanya logging, metrics, dan tracing?", saya identifikasi risiko operasional paling kritikal lebih dulu.
...
> Log untuk detail event, metric untuk tren, trace untuk alur; saya pakai bertingkat agar investigasi efisien.
...
- Definisi strategi: signal-layered diagnosis = pendekatan investigasi yang memakai logging, metrics, dan tracing sesuai fungsi masing-masing.
...
- Pertanyaan: Bedanya logging, metrics, dan tracing?
