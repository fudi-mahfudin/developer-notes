# Apa itu flaky test, dan cara menguranginya?

## 1) Pertanyaan

- Pertanyaan interviewer: Apa itu flaky test, dan cara menguranginya?
...
> Flaky test adalah test yang kadang lolos kadang gagal tanpa perubahan kode. Strategi saya determinism-first test hygiene: hilangkan sumber nondeterministic seperti race timing, shared state, dan dependency eksternal tak terkontrol. Saya juga pisahkan flaky test dari jalur merge utama sampai akar masalahnya diselesaikan.

Struktur cepat:
- Konteks singkat: pada kasus "Apa itu flaky test, dan cara menguranginya?", saya mulai dari risiko tertinggi yang memengaruhi user dan operasi.
...
> Flaky test saya tangani dengan determinism-first: stabilkan timing/state/dependency lalu kunci ulang di pipeline utama.
...
- Definisi strategi: determinism-first test hygiene = membersihkan faktor acak agar hasil test konsisten dan dapat dipercaya.
...
- Pertanyaan: Apa itu flaky test, dan cara menguranginya?
