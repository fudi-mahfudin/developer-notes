...
- Pertanyaan interviewer: Kapan harus fail fast?
...
> Fail-fast saya terapkan saat operasi jelas tidak bisa dipulihkan dalam konteks request saat itu, misalnya precondition invalid atau dependency hard-fail. Strategi saya early-rejection for stability: lebih baik gagal cepat dengan sinyal jelas daripada menahan resource sia-sia. Ini menjaga kapasitas sistem saat tekanan tinggi.

Struktur cepat:
- Konteks singkat: pada kasus "Kapan harus fail fast?", saya identifikasi risiko operasional paling kritikal lebih dulu.
...
> Saya pilih fail-fast ketika retry tidak memberi nilai, agar resource tidak habis untuk request yang sudah doomed.
...
- Definisi strategi: early-rejection for stability = menolak lebih awal kondisi yang tidak mungkin sukses demi menjaga stabilitas sistem.
...
- Pertanyaan: Kapan harus fail fast?
