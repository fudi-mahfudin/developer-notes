# Bagaimana observability yang baik di production?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana observability yang baik di production?
...
> Observability yang baik menurut saya harus menjawab tiga hal cepat: apa yang rusak, di mana rusaknya, dan seberapa besar dampaknya. Strategi saya triad observability baseline: logging terstruktur, metrik inti, dan tracing saling terhubung lewat correlation id. Dengan baseline ini, incident response lebih cepat dan keputusan perbaikan lebih akurat.

Struktur cepat:
- Konteks singkat: pada kasus "Bagaimana observability yang baik di production?", saya identifikasi risiko operasional paling kritikal lebih dulu.
...
> Saya bangun observability dari logging+metrics+tracing yang terhubung supaya diagnosis incident cepat dan presisi.
...
- Definisi strategi: triad observability baseline = fondasi observabilitas yang menggabungkan log, metrik, dan trace dalam satu konteks.
...
- Pertanyaan: Bagaimana observability yang baik di production?
