...
- Pertanyaan interviewer: Kapan memilih SQL vs NoSQL?
...
> Saya memilih SQL saat domain butuh konsistensi kuat, relasi kompleks, dan transaksi yang ketat; NoSQL saya pilih saat kebutuhan utama adalah fleksibilitas skema atau skala horizontal tertentu. Strategi saya consistency-first data model: keputusan storage dimulai dari kebutuhan integritas data, baru ke skala dan kecepatan evolusi. Dalam praktiknya, kombinasi polyglot sering valid selama batas tanggung jawab data jelas.

Struktur cepat:
- Konteks singkat: salah pilih database bisa mahal saat sistem tumbuh.
- Aksi utama: petakan kebutuhan transaksi, query pattern, dan evolusi schema.
- Keputusan teknis/non-teknis: gunakan polyglot hanya jika boundary data jelas.
- Hasil terukur: arsitektur data lebih stabil dan mudah dievolusi.
- Closing relevan ke posisi: saya memilih teknologi berdasarkan kebutuhan domain, bukan hype.

## 3) Versi Ultra Singkat (10-20 detik)

> SQL untuk konsistensi dan relasi kuat, NoSQL untuk fleksibilitas/skala tertentu; saya pilih dari kebutuhan integritas dulu.
...
- Definisi strategi: consistency-first data model = menentukan SQL/NoSQL dari kebutuhan integritas dan aturan bisnis terlebih dahulu.
...
- Pertanyaan: Kapan memilih SQL vs NoSQL?
