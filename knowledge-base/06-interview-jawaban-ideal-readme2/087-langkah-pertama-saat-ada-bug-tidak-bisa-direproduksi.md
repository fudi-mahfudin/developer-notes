# Langkah pertama saat ada bug “tidak bisa direproduksi”?

## 1) Pertanyaan

- Pertanyaan interviewer: Langkah pertama saat ada bug “tidak bisa direproduksi”?
...
> Kalau bug tidak bisa direproduksi, langkah pertama saya adalah memperkaya observability di jalur dicurigai: log kontekstual, trace, dan feature flag untuk isolasi. Strategi saya observability-assisted reproduction: bawa kondisi produksi lebih dekat ke lingkungan investigasi secara data-driven. Dengan ini, bug yang awalnya 'ghost issue' bisa dipetakan pola kemunculannya.

Struktur cepat:
- Konteks singkat: pada kasus "Langkah pertama saat ada bug “tidak bisa direproduksi”?", saya mulai dari risiko tertinggi yang memengaruhi user dan operasi.
...
> Bug sulit direpro saya tangani dengan observability-assisted reproduction agar pola kejadian terlihat jelas.
...
- Definisi strategi: observability-assisted reproduction = menggunakan data produksi terstruktur untuk mempermudah reproduksi bug intermiten.
...
- Pertanyaan: Langkah pertama saat ada bug “tidak bisa direproduksi”?
