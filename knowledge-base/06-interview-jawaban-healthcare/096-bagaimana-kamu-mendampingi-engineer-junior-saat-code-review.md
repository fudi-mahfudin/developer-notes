# Bagaimana kamu mendampingi engineer junior saat code review?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana kamu mendampingi engineer junior saat code review?
...
> Saat mendampingi engineer junior di code review, saya fokus pada reasoning di balik komentar, bukan hanya benar-salah implementasi. Saya biasanya pisahkan feedback menjadi wajib diperbaiki dan saran peningkatan agar tidak membebani sekaligus. Untuk pola kesalahan berulang, saya beri contoh kecil yang bisa langsung dipraktikkan di PR itu juga. Saya juga apresiasi bagian yang sudah bagus supaya proses review terasa membangun, bukan menghakimi. Target saya bukan sekadar merge PR, tapi meningkatkan kualitas keputusan teknis junior dari waktu ke waktu.

Struktur cepat:
- Konteks singkat: review yang terlalu keras bisa menghambat pertumbuhan engineer junior.
- Aksi utama: beri feedback terstruktur dan bisa langsung ditindaklanjuti.
- Keputusan teknis/non-teknis: utamakan transfer cara berpikir, bukan koreksi sintaks saja.
- Hasil terukur: kualitas PR junior membaik lebih cepat.
- Closing relevan ke posisi: saya melihat code review sebagai sarana scaling kualitas tim.

## 3) Versi Ultra Singkat (10-20 detik)

> Di code review junior, saya tekankan alasan teknis, prioritas feedback, dan pembelajaran praktis agar kualitasnya naik konsisten.
...
- Pertanyaan: Bagaimana kamu mendampingi engineer junior saat code review?
