# Bagaimana cara kamu mengelola ekspektasi stakeholder saat deadline ketat?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana cara kamu mengelola ekspektasi stakeholder saat deadline ketat?
...
> Saat deadline ketat, saya kelola ekspektasi stakeholder dengan transparansi scope, risiko, dan prioritas sejak awal. Saya biasanya bagi pekerjaan jadi tiga lapisan: must-have untuk rilis aman, should-have untuk iterasi cepat berikutnya, dan nice-to-have yang bisa ditunda. Di Siloam, pendekatan ini membantu saya tetap mendorong perbaikan performa tanpa mengorbankan stabilitas layanan. Saya update progres berbasis data, bukan janji umum, jadi stakeholder tahu apa yang benar-benar akan selesai. Hasilnya ekspektasi lebih realistis dan tekanan eksekusi lebih terkontrol.

Struktur cepat:
- Konteks singkat: deadline ketat butuh kejelasan prioritas, bukan optimisme berlebihan.
- Aksi utama: saya pecah scope jadi must-have/should-have/nice-to-have.
- Keputusan teknis/non-teknis: saya jaga quality baseline meski fitur dipersempit.
- Hasil terukur: rilis lebih prediktif dan risiko rollback menurun.
- Closing relevan ke posisi: saya bisa jaga trust stakeholder sekaligus kualitas delivery.

## 3) Versi Ultra Singkat (10-20 detik)

> Saya kelola ekspektasi dengan scope bertingkat dan update berbasis data, jadi rilis tetap aman meski deadline ketat.
...
- Pertanyaan: Bagaimana cara kamu mengelola ekspektasi stakeholder saat deadline ketat?
