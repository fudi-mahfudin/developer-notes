# Kapan kamu menulis unit test vs integration test vs e2e?

## 1) Pertanyaan

- Pertanyaan interviewer: Kapan kamu menulis unit test vs integration test vs e2e?
...
> Saya menulis unit test untuk logic murni yang butuh feedback cepat, integration test untuk kontrak antar komponen, dan e2e untuk validasi alur user yang paling kritikal. Pembagian ini membuat test suite tetap cepat dijalankan tapi tetap menangkap bug yang bermakna di level sistem. Kalau semua dipaksa e2e, tim akan lambat dan test jadi rapuh; kalau hanya unit, bug integrasi sering lolos. Jadi saya sengaja membangun lapisan test yang saling melengkapi, bukan saling menggantikan. Fokus akhirnya tetap sama: confidence rilis dengan biaya test yang masuk akal.

Struktur cepat:
- Konteks singkat: satu jenis test saja tidak cukup untuk kualitas produksi.
- Aksi utama: bagi tanggung jawab test per layer sesuai tujuannya.
- Keputusan teknis/non-teknis: optimalkan coverage bermakna, bukan jumlah test semata.
- Hasil terukur: bug integrasi turun tanpa membuat pipeline terlalu lambat.
- Closing relevan ke posisi: saya membangun strategi test yang praktis dan sustainable.

## 3) Versi Ultra Singkat (10-20 detik)

> Unit untuk logic, integration untuk kontrak, e2e untuk critical flow—saya kombinasikan agar cepat sekaligus cukup dalam.
...
- Pertanyaan: Kapan kamu menulis unit test vs integration test vs e2e?
