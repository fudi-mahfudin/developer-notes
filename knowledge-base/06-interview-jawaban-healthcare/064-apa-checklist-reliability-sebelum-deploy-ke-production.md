# Apa checklist reliability sebelum deploy ke production?

## 1) Pertanyaan

- Pertanyaan interviewer: Apa checklist reliability sebelum deploy ke production?
...
> Checklist reliability sebelum deploy saya bagi tiga lapis: readiness teknis, readiness operasional, dan readiness recovery. Readiness teknis mencakup test kritikal dan compatibility check; operasional mencakup metric, logging, alert; recovery mencakup rollback dan runbook. Saya tidak melanjutkan deploy kalau salah satu lapis masih abu-abu. Pendekatan ini membantu tim menghindari deploy yang “terlihat siap” tapi rapuh saat traffic real masuk. Bagi saya, checklist yang efektif adalah checklist yang benar-benar menghentikan deploy saat risiko masih tinggi.

Struktur cepat:
- Konteks singkat: banyak incident datang dari deploy yang lolos tanpa readiness lengkap.
- Aksi utama: validasi readiness teknis, operasional, dan recovery sebelum go-live.
- Keputusan teknis/non-teknis: no-go jika ada area kritikal yang belum hijau.
- Hasil terukur: kegagalan pasca-deploy menurun dan respons tim lebih terarah.
- Closing relevan ke posisi: saya disiplin di pre-deploy gate untuk jaga stabilitas layanan.

## 3) Versi Ultra Singkat (10-20 detik)

> Checklist deploy saya selalu cek tiga hal: siap jalan, siap dipantau, dan siap dipulihkan jika gagal.
...
- Pertanyaan: Apa checklist reliability sebelum deploy ke production?
