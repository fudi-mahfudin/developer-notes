# Bagaimana desain arsitektur migrasi modul lama tanpa ganggu operasi?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana desain arsitektur migrasi modul lama tanpa ganggu operasi?
...
> Migrasi modul lama tanpa ganggu operasi saya jalankan bertahap dengan prinsip strangler pattern: alur baru diaktifkan per bagian kecil sambil modul lama masih melayani. Saya pilih route/fitur paling aman untuk pilot, lalu ukur dampaknya sebelum memperluas cakupan. Saya juga siapkan rollback cepat di tiap tahap agar risiko tidak menumpuk. Pengalaman phased migration sebelumnya mengajarkan bahwa komunikasi lintas tim sama pentingnya dengan desain teknisnya. Jadi migrasi saya desain sebagai seri langkah kecil yang terkontrol, bukan one-shot big bang.

Struktur cepat:
- Konteks singkat: big-bang migration berisiko tinggi ke operasi harian.
- Aksi utama: rollout bertahap dengan checkpoint kualitas dan metrik dampak.
- Keputusan teknis/non-teknis: kurangi blast radius per fase, jangan semua sekaligus.
- Hasil terukur: transisi lebih stabil dan downtime bisa diminimalkan.
- Closing relevan ke posisi: saya berpengalaman menjalankan perubahan besar secara aman.

## 3) Versi Ultra Singkat (10-20 detik)

> Saya migrasi modul lama bertahap dengan rollout kecil terukur dan rollback cepat di tiap fase.
...
- Pertanyaan: Bagaimana desain arsitektur migrasi modul lama tanpa ganggu operasi?
