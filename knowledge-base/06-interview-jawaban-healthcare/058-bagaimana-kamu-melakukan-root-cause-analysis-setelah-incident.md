# Bagaimana kamu melakukan root cause analysis setelah incident?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana kamu melakukan root cause analysis setelah incident?
...
> Root cause analysis saya lakukan dengan struktur yang tegas: timeline kejadian, gejala, penyebab teknis, lalu gap proses yang membuatnya lolos. Saya hindari RCA yang hanya berhenti di “siapa salah”, karena itu tidak mencegah kejadian berulang. Di setiap RCA, saya pastikan action item punya owner, due date, dan indikator keberhasilan. Saya juga cek apakah guardrail yang seharusnya ada ternyata belum dipasang atau tidak efektif. Buat saya RCA yang baik adalah yang mengubah perilaku sistem, bukan dokumen yang disimpan lalu dilupakan.

Struktur cepat:
- Konteks singkat: RCA lemah membuat incident yang sama terus muncul.
- Aksi utama: susun timeline, identifikasi root cause, dan tetapkan aksi preventif terukur.
- Keputusan teknis/non-teknis: fokus ke perbaikan sistem, bukan menyalahkan individu.
- Hasil terukur: recurrence issue turun dan kesiapan tim naik.
- Closing relevan ke posisi: saya melihat RCA sebagai alat improvement berkelanjutan.

## 3) Versi Ultra Singkat (10-20 detik)

> RCA saya fokus ke penyebab sistemik + action item ber-owner, agar masalah yang sama tidak berulang.
...
- Pertanyaan: Bagaimana kamu melakukan root cause analysis setelah incident?
