# Bagaimana investigasi lonjakan error 500?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana investigasi lonjakan error 500?
...
> Lonjakan error 500 saya investigasi dari timeline deploy, perubahan dependency, dan pola endpoint terdampak. Strategi saya blast-radius-first triage: identifikasi cakupan dampak dulu sebelum mendalami akar masalah. Setelah itu baru drill down ke trace/log untuk menentukan apakah root cause ada di aplikasi, DB, atau layanan eksternal.

Struktur cepat:
- Konteks singkat: pada kasus "Bagaimana investigasi lonjakan error 500?", saya identifikasi risiko operasional paling kritikal lebih dulu.
...
> Saat error 500 naik, saya mulai dari blast radius, lalu drill down dengan trace/log sampai root cause jelas.
...
- Definisi strategi: blast-radius-first triage = memetakan dampak insiden lebih dulu agar penanganan awal tepat sasaran.
...
- Pertanyaan: Bagaimana investigasi lonjakan error 500?
