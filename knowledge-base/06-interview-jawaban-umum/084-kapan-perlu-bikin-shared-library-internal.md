# Kapan perlu bikin shared library internal?

## 1) Pertanyaan

- Pertanyaan interviewer: Kapan perlu bikin shared library internal?
...
> Shared library internal saya buat hanya saat ada pola berulang yang benar-benar stabil lintas tim, bukan karena ingin merapikan terlalu cepat. Strategi saya duplication-before-abstraction threshold: biarkan duplikasi sehat dulu sampai pola matang, baru diekstrak. Ini menghindari library prematur yang akhirnya jadi beban semua tim.

Struktur cepat:
- Konteks singkat: pada kasus "Kapan perlu bikin shared library internal?", saya mulai dari risiko tertinggi yang memengaruhi user dan operasi.
...
> Saya bikin shared library setelah pola terbukti stabil, bukan dari abstraksi prematur.
...
- Definisi strategi: duplication-before-abstraction threshold = menunda ekstraksi library sampai pola reuse benar-benar tervalidasi.
...
- Pertanyaan: Kapan perlu bikin shared library internal?
