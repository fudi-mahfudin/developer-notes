# Bagaimana memastikan kode mudah di-maintain tim?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana memastikan kode mudah di-maintain tim?
...
> Kode maintainable saya jaga lewat modularitas jelas, naming konsisten, dan batas tanggung jawab yang tegas per layer. Strategi saya maintainability by design: keputusan struktur diambil sejak awal, bukan menunggu kode membesar. Saya juga gunakan review checklist agar standar maintainability tidak tergantung preferensi personal.

Struktur cepat:
- Konteks singkat: pada kasus "Bagaimana memastikan kode mudah di-maintain tim?", saya mulai dari risiko tertinggi yang memengaruhi user dan operasi.
...
> Saya jaga maintainability lewat struktur modular, naming disiplin, dan review checklist yang konsisten.
...
- Definisi strategi: maintainability by design = merancang struktur kode dari awal agar mudah dibaca, diuji, dan dikembangkan tim.
...
- Pertanyaan: Bagaimana memastikan kode mudah di-maintain tim?
