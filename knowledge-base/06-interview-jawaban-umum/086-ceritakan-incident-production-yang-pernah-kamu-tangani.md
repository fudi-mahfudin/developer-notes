# Ceritakan incident production yang pernah kamu tangani.

## 1) Pertanyaan

- Pertanyaan interviewer: Ceritakan incident production yang pernah kamu tangani.
...
> Saat incident production, fokus pertama saya adalah restore layanan aman secepat mungkin, baru lanjut RCA mendalam. Strategi saya stabilize-then-learn: containment dulu, pembelajaran menyusul secara disiplin. Ini menjaga keseimbangan antara respons operasional cepat dan perbaikan jangka panjang.

Struktur cepat:
- Konteks singkat: pada kasus "Ceritakan incident production yang pernah kamu tangani.", saya mulai dari risiko tertinggi yang memengaruhi user dan operasi.
...
> Saat incident, saya dahulukan stabilisasi layanan lalu RCA mendalam agar perbaikan permanen tetap tercapai.
...
- Definisi strategi: stabilize-then-learn = memprioritaskan pemulihan layanan sebelum analisis akar masalah secara lengkap.
...
- Pertanyaan: Ceritakan incident production yang pernah kamu tangani.
