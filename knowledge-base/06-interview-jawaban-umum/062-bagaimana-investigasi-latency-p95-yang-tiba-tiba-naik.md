# Bagaimana investigasi latency p95 yang tiba-tiba naik?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana investigasi latency p95 yang tiba-tiba naik?
...
> Latency p95 yang naik tiba-tiba saya tangani dengan membandingkan baseline sebelum-sesudah kejadian, lalu pecah per layer: app, DB, dan external dependency. Strategi saya percentile-driven bottleneck hunt: fokus di ekor latency karena di situlah pengalaman user biasanya rusak. Saya validasi hipotesis lewat trace span dan query timing, bukan asumsi.

Struktur cepat:
- Konteks singkat: pada kasus "Bagaimana investigasi latency p95 yang tiba-tiba naik?", saya identifikasi risiko operasional paling kritikal lebih dulu.
...
> Saya investigasi p95 spike lewat baseline compare dan trace span untuk menemukan bottleneck nyata di layer yang tepat.
...
- Definisi strategi: percentile-driven bottleneck hunt = investigasi performa yang memprioritaskan sumber lonjakan di persentil tinggi.
...
- Pertanyaan: Bagaimana investigasi latency p95 yang tiba-tiba naik?
