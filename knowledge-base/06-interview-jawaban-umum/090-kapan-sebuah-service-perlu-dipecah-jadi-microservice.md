# Kapan sebuah service perlu dipecah jadi microservice?

## 1) Pertanyaan

- Pertanyaan interviewer: Kapan sebuah service perlu dipecah jadi microservice?
...
> Service perlu dipecah jadi microservice saat batas domain sudah jelas dan bottleneck tim/scale tidak bisa lagi diselesaikan efektif di monolith. Strategi saya constraint-driven decomposition: pecah layanan karena kebutuhan nyata, bukan karena tren arsitektur. Dengan ini, kompleksitas tambahan microservice tetap sepadan dengan manfaatnya.

Struktur cepat:
- Konteks singkat: pada kasus "Kapan sebuah service perlu dipecah jadi microservice?", saya mulai dari risiko tertinggi yang memengaruhi user dan operasi.
...
> Saya pecah ke microservice saat ada constraint nyata pada scale/ownership, bukan sekadar ikut tren.
...
- Definisi strategi: constraint-driven decomposition = pemecahan layanan berdasarkan batasan operasional dan kebutuhan domain yang terbukti.
...
- Pertanyaan: Kapan sebuah service perlu dipecah jadi microservice?
