# Jelaskan strategi testing pyramid.

## 1) Pertanyaan

- Pertanyaan interviewer: Jelaskan strategi testing pyramid.
...
> Testing pyramid saya terapkan dengan porsi terbesar di unit test, lalu integration test untuk kontrak antarkomponen, dan e2e seperlunya untuk jalur kritikal bisnis. Strategi saya risk-layered testing: tiap level test punya tujuan jelas dan tidak saling duplikasi berlebihan. Dengan komposisi ini, feedback tetap cepat tanpa kehilangan perlindungan terhadap regresi utama.

Struktur cepat:
- Konteks singkat: pada kasus "Jelaskan strategi testing pyramid.", saya mulai dari risiko tertinggi yang memengaruhi user dan operasi.
...
> Saya pakai risk-layered testing: unit dominan, integration terarah, e2e secukupnya untuk jalur bisnis kritikal.
...
- Definisi strategi: risk-layered testing = mendistribusikan test berdasarkan level risiko dan biaya eksekusi.
...
- Pertanyaan: Jelaskan strategi testing pyramid.
