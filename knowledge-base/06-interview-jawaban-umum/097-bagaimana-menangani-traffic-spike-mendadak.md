# Bagaimana menangani traffic spike mendadak?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana menangani traffic spike mendadak?
...
> Traffic spike mendadak saya tangani dengan kombinasi autoscaling, rate limiting, queue buffering, dan graceful degradation. Strategi saya surge-containment playbook: lindungi komponen inti dulu, lalu pulihkan kapasitas bertahap. Pendekatan ini mengurangi risiko total outage saat lonjakan tidak terduga.

Struktur cepat:
- Konteks singkat: pada kasus "Bagaimana menangani traffic spike mendadak?", saya mulai dari risiko tertinggi yang memengaruhi user dan operasi.
...
> Saat spike, saya jalankan surge-containment: throttle, buffer, scale, dan degrade terkontrol untuk menjaga layanan inti.
...
- Definisi strategi: surge-containment playbook = rangkaian mitigasi lonjakan trafik untuk menjaga stabilitas layanan kritikal.
...
- Pertanyaan: Bagaimana menangani traffic spike mendadak?
