...
- Topik utama: Linked List/Floyd
- Inti masalah (1-2 kalimat): Menyelesaikan linked list cycle dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Linked List Cycle.
...
- Pola yang terdeteksi: Linked List/Floyd.
...
- Ide: Terapkan pendekatan Linked List/Floyd yang paling lazim dipakai untuk problem ini.
