...
- Inti masalah (1-2 kalimat): Menyelesaikan longest consecutive sequence dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Longest Consecutive Sequence.
...
- Pola yang terdeteksi: Array/HashSet.
...
- Ide: Terapkan pendekatan Array/HashSet yang paling lazim dipakai untuk problem ini.
