...
- Topik utama: Graph/Topological Sort
- Inti masalah (1-2 kalimat): Menyelesaikan course schedule ii dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Course Schedule II.
...
- Pola yang terdeteksi: Graph/Topological Sort.
...
- Ide: Terapkan pendekatan Graph/Topological Sort yang paling lazim dipakai untuk problem ini.
...
function courseScheduleIi(graph, start) {
