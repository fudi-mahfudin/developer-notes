...
- Inti masalah (1-2 kalimat): Menyelesaikan sort colors dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Sort Colors.
...
- Pola yang terdeteksi: Array/Two Pointers.
...
- Ide: Terapkan pendekatan Array/Two Pointers yang paling lazim dipakai untuk problem ini.
