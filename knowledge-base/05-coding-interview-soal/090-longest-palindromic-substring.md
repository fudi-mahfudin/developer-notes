...
- Inti masalah (1-2 kalimat): Menyelesaikan longest palindromic substring dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Longest Palindromic Substring.
...
- Pola yang terdeteksi: DP/String.
...
- Ide: Terapkan pendekatan DP/String yang paling lazim dipakai untuk problem ini.
...
function longestPalindromicSubstring(n) {
  if (n <= 1) return n;
