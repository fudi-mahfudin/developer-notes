...
- Topik utama: Linked List/HashMap/Design
- Inti masalah (1-2 kalimat): Menyelesaikan lru cache dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal LRU Cache.
...
- Pola yang terdeteksi: Linked List/HashMap/Design.
...
- Ide: Terapkan pendekatan Linked List/HashMap/Design yang paling lazim dipakai untuk problem ini.
