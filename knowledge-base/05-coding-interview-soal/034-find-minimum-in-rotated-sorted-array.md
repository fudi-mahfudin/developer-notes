...
- Inti masalah (1-2 kalimat): Menyelesaikan find minimum in rotated sorted array dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Find Minimum in Rotated Sorted Array.
