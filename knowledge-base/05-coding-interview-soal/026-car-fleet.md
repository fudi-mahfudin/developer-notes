...
- Topik utama: Stack/Sorting
- Inti masalah (1-2 kalimat): Menyelesaikan car fleet dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Car Fleet.
...
- Pola yang terdeteksi: Stack/Sorting.
...
- Ide: Terapkan pendekatan Stack/Sorting yang paling lazim dipakai untuk problem ini.
