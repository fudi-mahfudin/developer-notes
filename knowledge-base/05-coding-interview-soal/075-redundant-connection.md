...
- Topik utama: Graph/Union Find
- Inti masalah (1-2 kalimat): Menyelesaikan redundant connection dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Redundant Connection.
...
- Pola yang terdeteksi: Graph/Union Find.
...
- Ide: Terapkan pendekatan Graph/Union Find yang paling lazim dipakai untuk problem ini.
...
function redundantConnection(graph, start) {
