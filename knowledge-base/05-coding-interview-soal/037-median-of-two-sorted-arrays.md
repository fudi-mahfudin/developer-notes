...
- Inti masalah (1-2 kalimat): Menyelesaikan median of two sorted arrays dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Median of Two Sorted Arrays.
...
function medianOfTwoSortedArrays(nums, target) {
  let left = 0;
