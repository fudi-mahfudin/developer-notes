...
- Topik utama: Backtracking/Grid
- Inti masalah (1-2 kalimat): Menyelesaikan word search dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Word Search.
...
- Pola yang terdeteksi: Backtracking/Grid.
...
- Ide: Terapkan pendekatan Backtracking/Grid yang paling lazim dipakai untuk problem ini.
