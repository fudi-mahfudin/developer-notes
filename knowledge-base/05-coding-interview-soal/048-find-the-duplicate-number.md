...
- Topik utama: Two Pointers/Floyd
- Inti masalah (1-2 kalimat): Menyelesaikan find the duplicate number dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Find the Duplicate Number.
...
- Pola yang terdeteksi: Two Pointers/Floyd.
...
- Ide: Terapkan pendekatan Two Pointers/Floyd yang paling lazim dipakai untuk problem ini.
