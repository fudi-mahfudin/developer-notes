...
- Topik utama: Linked List/Math
- Inti masalah (1-2 kalimat): Menyelesaikan add two numbers dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Add Two Numbers.
...
- Pola yang terdeteksi: Linked List/Math.
...
- Ide: Terapkan pendekatan Linked List/Math yang paling lazim dipakai untuk problem ini.
