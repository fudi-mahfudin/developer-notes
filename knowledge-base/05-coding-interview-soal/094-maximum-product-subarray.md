...
- Topik utama: DP
- Inti masalah (1-2 kalimat): Menyelesaikan maximum product subarray dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Maximum Product Subarray.
...
function maximumProductSubarray(n) {
  if (n <= 1) return n;
