...
- Inti masalah (1-2 kalimat): Menyelesaikan peak index in a mountain array dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Peak Index in a Mountain Array.
...
- Pola yang terdeteksi: Binary Search.
...
- Ide: Terapkan pendekatan Binary Search yang paling lazim dipakai untuk problem ini.
...
function peakIndexInAMountainArray(nums, target) {
  let left = 0;
