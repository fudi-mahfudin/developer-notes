...
- Topik utama: Graph/BFS
- Inti masalah (1-2 kalimat): Menyelesaikan rotting oranges dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Rotting Oranges.
...
- Pola yang terdeteksi: Graph/BFS.
...
- Ide: Terapkan pendekatan Graph/BFS yang paling lazim dipakai untuk problem ini.
...
function rottingOranges(graph, start) {
