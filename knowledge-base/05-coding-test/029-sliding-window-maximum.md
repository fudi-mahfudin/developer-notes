...
- Topik utama: Deque
- Inti masalah (1-2 kalimat): Menyelesaikan sliding window maximum dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Sliding Window Maximum.
...
- Ide: Terapkan pendekatan Deque yang paling lazim dipakai untuk problem ini.
