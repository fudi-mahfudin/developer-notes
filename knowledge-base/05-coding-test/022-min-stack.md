...
- Inti masalah (1-2 kalimat): Menyelesaikan min stack dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Min Stack.
...
- Pola yang terdeteksi: Stack/Design.
...
- Ide: Terapkan pendekatan Stack/Design yang paling lazim dipakai untuk problem ini.
