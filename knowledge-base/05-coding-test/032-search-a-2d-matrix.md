...
- Inti masalah (1-2 kalimat): Menyelesaikan search a 2d matrix dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Search a 2D Matrix.
...
function searchA2dMatrix(nums, target) {
  let left = 0;
