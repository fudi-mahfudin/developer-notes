...
- Topik utama: String
- Inti masalah (1-2 kalimat): Menyelesaikan encode and decode strings dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Encode and Decode Strings.
...
- Ide: Terapkan pendekatan String yang paling lazim dipakai untuk problem ini.
...
function encodeAndDecodeStrings(nums) {
  return nums.length;
}
```
