...
- Topik utama: Graph/DFS
- Inti masalah (1-2 kalimat): Menyelesaikan pacific atlantic water flow dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Pacific Atlantic Water Flow.
...
- Pola yang terdeteksi: Graph/DFS.
...
- Ide: Terapkan pendekatan Graph/DFS yang paling lazim dipakai untuk problem ini.
...
function pacificAtlanticWaterFlow(graph, start) {
