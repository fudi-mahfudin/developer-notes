...
- Inti masalah (1-2 kalimat): Menyelesaikan largest rectangle in histogram dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Largest Rectangle in Histogram.
...
- Pola yang terdeteksi: Monotonic Stack.
...
- Ide: Terapkan pendekatan Monotonic Stack yang paling lazim dipakai untuk problem ini.
