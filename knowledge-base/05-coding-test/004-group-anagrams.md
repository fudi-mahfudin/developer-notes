...
- Inti masalah (1-2 kalimat): Menyelesaikan group anagrams dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Group Anagrams.
...
- Pola yang terdeteksi: String/HashMap.
...
- Ide: Terapkan pendekatan String/HashMap yang paling lazim dipakai untuk problem ini.
