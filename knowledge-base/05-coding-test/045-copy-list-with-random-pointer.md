...
- Topik utama: Linked List/HashMap
- Inti masalah (1-2 kalimat): Menyelesaikan copy list with random pointer dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Copy List with Random Pointer.
...
- Pola yang terdeteksi: Linked List/HashMap.
...
- Ide: Terapkan pendekatan Linked List/HashMap yang paling lazim dipakai untuk problem ini.
