...
- Topik utama: DP/Grid
- Inti masalah (1-2 kalimat): Menyelesaikan unique paths dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Unique Paths.
...
- Ide: Terapkan pendekatan DP/Grid yang paling lazim dipakai untuk problem ini.
