...
- Inti masalah (1-2 kalimat): Menyelesaikan koko eating bananas dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Koko Eating Bananas.
...
function kokoEatingBananas(nums, target) {
  let left = 0;
