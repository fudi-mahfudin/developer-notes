...
- Topik utama: Array/Voting
- Inti masalah (1-2 kalimat): Menyelesaikan majority element dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Majority Element.
...
- Pola yang terdeteksi: Array/Voting.
...
- Ide: Terapkan pendekatan Array/Voting yang paling lazim dipakai untuk problem ini.
