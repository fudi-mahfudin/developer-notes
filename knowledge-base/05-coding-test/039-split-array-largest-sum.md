...
- Topik utama: Binary Search/Greedy
- Inti masalah (1-2 kalimat): Menyelesaikan split array largest sum dengan strategi yang benar secara logika, efisien terhadap constraints, dan aman terhadap edge case klasik interview.

## 2) Detail Soal

- Input: Parameter mengikuti definisi soal Split Array Largest Sum.
...
- Pola yang terdeteksi: Binary Search/Greedy.
...
- Ide: Terapkan pendekatan Binary Search/Greedy yang paling lazim dipakai untuk problem ini.
...
function splitArrayLargestSum(nums, target) {
  let left = 0;
