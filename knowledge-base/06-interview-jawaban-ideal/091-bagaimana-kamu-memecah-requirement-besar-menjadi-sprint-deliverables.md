# Bagaimana kamu memecah requirement besar menjadi sprint deliverables?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana kamu memecah requirement besar menjadi sprint deliverables?
...
> Saat mendapat requirement besar, saya pecah dulu menjadi outcome bisnis yang bisa diukur per sprint, bukan langsung memecah berdasarkan komponen teknis. Dari sana saya susun irisan deliverable yang sudah memberi nilai meski belum fitur penuh. Saya pastikan tiap sprint punya definisi selesai yang jelas dan bisa didemokan ke stakeholder. Kalau ada ketidakpastian tinggi, saya sisipkan discovery task kecil di awal untuk menurunkan risiko estimasi. Dengan pendekatan ini, tim tetap bergerak terarah dan stakeholder melihat progres nyata tiap iterasi.

Struktur cepat:
- Konteks singkat: requirement besar sering membuat sprint kehilangan fokus.
- Aksi utama: pecah scope berdasarkan outcome bisnis yang bisa dirilis bertahap.
- Keputusan teknis/non-teknis: utamakan deliverable bernilai lebih dulu, bukan teknis sempurna dulu.
- Hasil terukur: progres sprint lebih jelas dan feedback datang lebih cepat.
- Closing relevan ke posisi: saya terbiasa mengubah scope besar jadi eksekusi mingguan yang realistis.

## 3) Versi Ultra Singkat (10-20 detik)

> Saya pecah requirement besar jadi irisan nilai bisnis per sprint, dengan definisi selesai yang jelas dan risiko diturunkan sejak awal.
...
- Pertanyaan: Bagaimana kamu memecah requirement besar menjadi sprint deliverables?
