# Bagaimana kamu memvalidasi edge case dari requirement yang ambigu?

## 1) Pertanyaan

- Pertanyaan interviewer: Bagaimana kamu memvalidasi edge case dari requirement yang ambigu?
...
> Untuk edge case requirement ambigu, saya lakukan klarifikasi cepat sambil menulis asumsi eksplisit yang bisa divalidasi stakeholder. Saya biasanya susun beberapa skenario input-output yang merepresentasikan kondisi batas, lalu minta konfirmasi mana yang dianggap benar secara bisnis. Setelah itu edge case tersebut saya jadikan test case wajib sebelum merge. Pendekatan ini mencegah tim coding dengan interpretasi berbeda-beda. Intinya, ambiguity saya ubah jadi keputusan terverifikasi, bukan dibiarkan jadi tebakan.

Struktur cepat:
- Konteks singkat: requirement ambigu adalah sumber bug yang mahal diperbaiki belakangan.
- Aksi utama: konversi ambiguity menjadi skenario testable dan asumsi tertulis.
- Keputusan teknis/non-teknis: pastikan validasi bisnis terjadi sebelum implementasi final.
- Hasil terukur: rework karena salah tafsir requirement berkurang.
- Closing relevan ke posisi: saya menjaga alignment produk-teknis sejak awal.

## 3) Versi Ultra Singkat (10-20 detik)

> Saat requirement ambigu, saya ubah jadi skenario teruji dan asumsi eksplisit yang disetujui stakeholder sebelum lanjut coding.
...
- Pertanyaan: Bagaimana kamu memvalidasi edge case dari requirement yang ambigu?
